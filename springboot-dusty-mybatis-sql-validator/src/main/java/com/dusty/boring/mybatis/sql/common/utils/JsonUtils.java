...
public class JsonUtils {
    ...
    public static String object2String(Object object) {
        ...
        try {
            //objectMapper.writer().writeValueAsString(object);
    ...
    public static <T> List<T> readListValue(String json, Class<T> tClazz) {
        ...
        return JsonUtils.readValue(json, List.class, tClazz);
    }
    
    
    public static <T> List<T> readListValue(List<Map> datas, Class<T> tClazz) {
        
        if (CollectionUtils.isEmpty(datas))
            return null;
        
        return JsonUtils.readValue(JsonUtils.object2String(datas), List.class, tClazz);
    }
    ...
    public static Map<String, Object> read2Map(String content) {
     ...
     * @param parametrized Actual full type （如：ArrayList.class）
     * @param parameterClasses Type parameters to apply （用户泛型Bean）
     * @param <T>  结果泛型
     * @return     响应结果
     * </pre>
     */
